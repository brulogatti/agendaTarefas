...
/**
 * Servlet implementation class ActivitiesSearchServlet
 */
@WebServlet(urlPatterns= {"/search"})
public class ActivitiesSearchServlet extends HttpServlet {
     ...
     */
    public ActivitiesSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			try {
				List<Agenda> agenda = agendaDao.searchActivities(user.getId(),search);
